        ...
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
            <div class="flex w-full mb-20 flex-wrap">
                ...
                <p class="lg:pl-6 lg:w-2/3 mx-auto sm:text-xl font-light text-gray-400 text-justify">
                    ...
                    sino también del espíritu de empoderamiento que nos impulsa todos los días.
                </p>
            ...
            <div class="flex flex-wrap md:-m-2 -m-1">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="grid gap-4">
                        ...
                        <div>
                            <video class="h-auto max-w-full rounded-lg" src="/src/assets/img/video2.mp4" autoplay loop muted></video>
                    ...
                    <div class="grid gap-4">
                        ...
                        <div>
                            <img class="h-auto max-w-full rounded-lg" src="/src/assets/img/photo9.webp" alt="">
                        </div>
                        <div>
                            <img class="h-auto max-w-full rounded-lg" src="/src/assets/img/photo15.jpg" alt="">
                        </div>
                    </div>
                    <div class="grid gap-4">
                        <div>
                    ...
                    <div class="grid gap-4">
                        <div>
                            <img class="h-auto max-w-full rounded-lg" src="/src/assets/img/photo1.jpeg" alt="">
                        </div>
                        <div>
