        ...
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6"  v-motion-fade>
            <div class="font-light  sm:text-lg text-gray-400">
                ...
                <p class="mb-4 sm:text-xl text-justify">
                    ...
                    una barra de dominadas y la visión de construir un refugio de fitness que fomente el compañerismo, 
                    la determinación y un compromiso compartido con la excelencia.
                </p>
                <p class="sm:text-xl">
            ...
            <div class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg" src="/src/assets/img/photos16.jpg" alt="office content 1">
                <img class="mt-4 w-full lg:mt-10 rounded-lg" src="/src/assets/img/photos17.jpg" alt="office content 2">
            </div>
        </div>
    </section>
